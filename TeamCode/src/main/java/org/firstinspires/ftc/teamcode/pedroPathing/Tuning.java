    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case RECORD: {
                ...
                telemetryA.addLine("Test " + iteration + ": " +
            ...
            case DONE: {
                ...
                telemetryA.addData("kQuadratic", coefficients[1]);
                telemetryA.addData("kLinear", coefficients[0]);
                telemetryA.update();
                telemetryA.addLine("Tuning Complete");
                telemetryA.addLine("Braking Profile:");
                telemetryA.addData("kQuadraticFriction", coefficients[1]);
                telemetryA.addData("kLinearBraking", coefficients[0]);
                for (BrakeRecord record : brakeData) {
                    Pose p = record.pose;
                    telemetryA.addLine(String.format("t=%.0f ms, x=%.2f, y=%.2f, θ=%.2f, v=%.2f",
